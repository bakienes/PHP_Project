...
<?php include "library/menu.php" ?>
  ...
  <div class="alert alert-primary" role="alert">
      Hoşgeldin Patron "<?php echo $_SESSION["yonetici"];?>" Bugün Nasılsın? ^_^ 
  </div>
          <div class="row">
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Toplam Kullanıcı Sayısı</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">

                      <?php $query = $db->query("SELECT * FROM uyeler", PDO::FETCH_ASSOC);
                        if ( $query->rowCount() ){ 
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Toplam Ders Sayısı</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">
					
                      <?php $query = $db->query("SELECT * FROM dersler", PDO::FETCH_ASSOC);
                        if ( $query->rowCount() ){ 
                        foreach( $query as $row ){
                          print $row['ders_id']."<br>";
                        }
                      } ?>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Toplam Bağış Fiyatı</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">

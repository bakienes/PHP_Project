          ...
          if($ayni_uye_varmi -> rowCount()){
            ...
            Bu kullanıcı adı zaten alınmış. Lütfen farklı bir kullanıcı adı deneyin. 
             ...
             if ($uye_ekle){
               ...
               Kayıt İşlemi Başarıyla Tamamlandı. Giriş Paneline Yönlendiriliyorsunuz ... 
               </div>';
...
?>
            <form method="post" action="">
                ...
                <div class="form-group">
                    <label>Şifre: (*)</label>
                    <input type="password" class="form-control" placeholder="Şifre Belirleyiniz" name="uye_sifre">
                </div>
                <div class="form-group">
                    <label>E-Posta: (*)</label>
                ...
                <div class="form-group form-check">
                    ...
                    <label class="form-check-label">Üyelik Şartlarını Kabul Ediyorum (*)</label>
                </div>
